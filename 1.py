...
# Configure grid weights for the root window to ensure responsiveness
root.grid_rowconfigure(1, weight=1) # Row 1 (content_frame) expands vertically
root.grid_columnconfigure(0, weight=1) # Column 0 (content_frame) expands horizontally
...
header_frame.grid(row=0, column=0, sticky='ew') # Header always at top, stretches horizontally
...
content_frame.grid(row=1, column=0, sticky='nsew') # Fills the remaining space in root window

# Configure content_frame grid weights for left/right panel distribution
